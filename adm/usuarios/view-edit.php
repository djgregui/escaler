...
<!-- Informações -->
    <div class="row">
        ...
        <div class="col-4">
                <h6><b>Email *</b></h6>
               <p style="border-radius:6px; background-color:white; height:40px; line-height:40px; padding-left:20px" class="text-muted">
                    <?=$usuario['email']?>
                </p>
        </div>
...
<div class="row">
    ...
    <div class="col-12 text-right">
        <div class="btn-group">
                <a href="<?=BASEURL?>adm/usuarios/index.php" class="btn btn-warning">Voltar</a>
